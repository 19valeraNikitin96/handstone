            ...
            <form action='/hs/register' method='POST' >
                ...
                <p >
                    ...
                    <p >
                        ...
                        <input required type='radio' name='cla$$' value='Warrior'>Warrior
                        <input required type='radio' name='cla$$' value='Robber'>Robber
                        <input required type='radio' name='cla$$' value='Devil'>Devil
                    </p>
                <p align='center'>
